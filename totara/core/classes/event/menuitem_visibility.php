...
class menuitem_visibility extends \core\event\base {
    ...
    protected function get_legacy_logdata() {
        ...
        return array(SITEID, 'totara_core', 'menu item updated', "index.php?{$id}={$this->objectid}", $this->objectid);
    }
    ...
    public function get_url() {
        $id = $this->other['status'] . 'id';
        return new \moodle_url('/totara/core/menu/index.php', array($id => $this->objectid));
    }
