...
$string['seedlingsmessage'] = 'WARNING: Totara Seedlings is a developer-only release of TotaraLMS for testing only and is not designed for use in a production environment. For a live site you should subscribe to <a href="http://totaralms.com/subscribe">TotaraLMS Enterprise</a> to receive stable releases, technical support and ongoing bug fixes.';
