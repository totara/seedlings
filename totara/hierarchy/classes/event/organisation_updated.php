...
class organisation_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventupdated', 'hierarchy_organisation');
    }
    ...
    public function get_description() {
        return "The organisation {$this->objectid} was updated by user {$this->userid}";
    }
    ...
    public function get_url() {
        return new \moodle_url('/totara/hierarchy/item/edit.php', array('prefix' => 'organisation', 'id' => $this->objectid));
    }
    ...
    protected function get_legacy_logdata() {
        return array(SITEID, 'organisation', 'updated', 'edit.php?id=' . $this->objectid, 'ID: ' . $this->objectid);
    }
