...
certificate_print_text($pdf, $x, $y + 92, 'C', 'Helvetica', '', 14, $timecompleted);
certificate_print_text($pdf, $x, $y + 102, 'C', 'Times', '', 10, $grade);
certificate_print_text($pdf, $x, $y + 112, 'C', 'Times', '', 10, $outcome);
