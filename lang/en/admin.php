...
$string['pwchangelogout'] = 'Logout others after password change';
$string['pwchangelogout_desc'] = 'Terminate all other user sessions after change of password. Password changes from bulk user uploads are ignored.';
