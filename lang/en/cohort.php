...
$string['event_cohort_created'] = 'Audience created';
$string['event_cohort_deleted'] = 'Audience deleted';
$string['event_cohort_member_added'] = 'User added to a audience';
$string['event_cohort_member_removed'] = 'User removed from a audience';
$string['event_cohort_updated'] = 'Audience updated';
$string['name'] = 'Name';
